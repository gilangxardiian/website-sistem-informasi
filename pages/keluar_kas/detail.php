...
<head>
    ...
    <title>Mankas · Detail Pengeluaran</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Info Detail Pengeluaran :</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <!-- Content Row -->
                            <?php if (isset($_GET["id_pengeluaran"])) { ?>
                                ...
                                $pengeluarans = query("SELECT * FROM pengeluaran WHERE idPengeluaran = $id AND statusAktif = '1'")[0];

                                // jika variabel id belum mendapatkan nilai dari url
                                if ($id === $pengeluarans["idPengeluaran"]) { ?>
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 text-center">
                                            <h2>Info Detail Pengeluaran</h2>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 d-flex justify-content-center text-center align-items-center">
                                            <table cellspacing="0" cellpadding="10">
                                                <tr>
                                                    <td style="text-align: end;">Nama Pengeluaran</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= $pengeluarans["namaPengeluaran"];  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: end;">Nominal</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= "Rp" . number_format($pengeluarans["nominal"]); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: end;">Tanggal Pengeluaran</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= $pengeluarans["tglPengeluaran"];  ?></td>
                                                </tr>
                                                <!-- menentukan selisih waktu penyetoran -->
                                                <?php
                                                // ambil data tanggal diterima yang telah dikirimkan sebelumnya
                                                $tanggalSetor = new DateTime($pengeluarans["tglPengeluaran"]);

                                                // set tanggal hari ini
                                                $hriIni = new DateTime('today');

                                                // menghitung selisih waktu antara dua tanggal
                                                $selisih = $tanggalSetor->diff($hriIni);
                                                ?>
                                                <!-- akhir menentukan selisih waktu penyetoran -->
                                                <tr>
                                                    <td style="text-align: end;">Waktu</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= $selisih->format('%a Hari yang lalu'); ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
