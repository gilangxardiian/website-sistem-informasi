        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseSetorKas" class="collapse" aria-labelledby="headingSetorKas" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../masuk_kas/">Setor Kas</a>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" aria-label=".form-control-sm example" type="text" name="namaPengeluaran" id="namaPengeluaran" required />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="nominal">Nominal :</label>
                                            <input class="form-control form-control-sm" aria-label=".form-control-sm example" type="number" name="nominal" id="nominal" required />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="tglPengeluaran">Tanggal Pengeluaran :</label>
                                            <input class="form-control form-control-sm" type="date" style="height: 38px;" aria-label=".form-control-sm example" name="tglPengeluaran" id="tglPengeluaran" required />
                                        </div>
                                    </div>
                            ...
                            if (isset($_POST["kirim"])) { ?>
                                ...
                                <?php } else if (catatPengeluaran($_POST) === -1) { ?>
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-10 offset-md-1">
