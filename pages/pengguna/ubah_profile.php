...
<head>
    ...
    <title>Infaqin · Ubah Profile</title>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <label for="nama_pengguna">Ganti Nama</label>
                                                    <input class="form-control" type="text" value="<?= $pengguna["namaPengguna"]; ?>" placeholder="Ganti Nama..." name="nama_pengguna" id="nama_pengguna" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
