                    ...
                    <div class="row">
                        <div class="offset-lg-1 col-lg-10">
                            <div class="card shadow mb-4">
                                ...
                                <!-- card body -->
                                <div class="card-body">
                                    <center><img class="mt-2 rounded-circle" src="../../assets/img/pengguna/<?= $infUsers["gambar"]; ?>" alt="Profile" width="200px" height="200px"></center>
                                    <p>
                                        <b>
                                            <center><?= $infUsers["namaPengguna"]; ?></center>
                                        </b>
                                    </p>
                                </div>
                            </div>
