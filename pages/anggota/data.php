...
$jumlahData = count(query("SELECT * FROM anggota WHERE statusAktif = '1'"));
...
$anggotas = query("SELECT * FROM anggota WHERE statusAktif = '1' LIMIT $awalData, $jmlDataPerHlmn");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h7 class="m-0 font-weight-bold">Kapasitas Anggota: <?= $kapasitas = 30; ?></h7>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-8 d-md-flex justify-content-md-end">
                                    <form class="form-inline my-2 my-lg-0" action="" method="post" name="cari">
                                        <input class="form-control mr-sm-2" type="search" placeholder="Cari anggota...." aria-label="Search" name="keyword" id="keyword" required>
                            ...
                            if (isset($_POST["cari"])) { ?>
                                <?php
                                // maka update variabel anggotas
                                $anggotas = cariAnggota($_POST["keyword"]);
                                // jika fungsi cek mengembalikan nilai lebih dari nol
                                if (cekAnggota($_POST["keyword"]) > 0) { ?>
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-10 offset-md-1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($anggotas as $anggota) : ?>
                                                <tr>
                                                    ...
                                                    <td>&nbsp;
                                                        <a href="detail.php?id_anggota=<?= $anggota["idAnggota"]; ?>">
                                                            <button type="button" class="btn btn-info">Detail</button>
                                                        </a>&nbsp;
                                                        <a href="ubah.php?id_anggota=<?= $anggota["idAnggota"]; ?>">
                                                            <button type="button" class="btn btn-success">Ubah</button>
                                                        </a>&nbsp;
                                                        <a href="hapus.php?id_anggota=<?= $anggota["idAnggota"]; ?>">
