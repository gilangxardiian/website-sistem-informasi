                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Setor Kas :</h6>
                        </div>
                        <!-- card body -->
                        <div class="card-body">
                            <?php
                            // ambil fungsi koneksi dan tampung kedalam variabel
                            $koneksi = koneksi();
                            // lakukan kueri penampilan data
                            $anggotas = mysqli_query($koneksi, "SELECT * FROM anggota WHERE statusAktif = '1'");
                            ?>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="idAnggota" id="idAnggota" style="height: 38px;" required>
                                                <option value="">-- pilih anggota--</option>
                                                <?php while ($row = mysqli_fetch_assoc($anggotas)) { ?>
                                                    <option value="<?= $row["idAnggota"]; ?>"><?= $row["namaAnggota"]; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" style="height: 38px;" aria-label=".form-control-sm example" type="text" name="nominal" id="nominal" required />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="bentuk" id="cash" value="Cash" required />
                                                <label class="form-check-label mr-4" for="cash">Cash</label>
                                                <input class="form-check-input" type="radio" name="bentuk" id="transfer" value="Transfer" required />
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="date" style="height: 38px;" aria-label=".form-control-sm example" name="tglSetor" id="tglSetor" required />
                                        </div>
                                    </div>
