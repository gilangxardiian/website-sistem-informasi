                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 d-flex justify-content-center text-center align-items-center">
                                            <table cellspacing="0" cellpadding="10">
                                                <tr>
                                                    ...
                                                    <td style="text-align: start;"><?= $kas["namaAnggota"];  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: end;">Nominal</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= "Rp" . number_format($kas["nominal"]); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: end;">Bentuk</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= $kas["bentuk"];  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: end;">Tanggal Setor</td>
                                                    <td style="text-align: center;">:</td>
                                                    <td style="text-align: start;"><?= $kas["tglSetor"];  ?></td>
                                                </tr>
                                                <!-- menentukan selisih waktu penyetoran -->
                                                <?php
                                                // ambil data tanggal diterima yang telah dikirimkan sebelumnya
                                                $tanggalSetor = new DateTime($kas["tglSetor"]);
